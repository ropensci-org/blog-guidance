...
### Comparing your work to other tools

If your post compares your package to other tools that solve a similar problem, aim for a comparison that's accurate, evidence-based, and fair.
Be nice, remember that those tools are built by people who probably care about them.
