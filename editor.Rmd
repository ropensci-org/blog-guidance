...
Copy and paste either the [editor checklist for a post about a peer-reviewed package](#editorchecklistpeer), or the [editor checklist for any other post](#editorchecklistany), into the box that appears when you click the green _Review changes_ button.
...
After all inline commenting and the checklist is done, add any further notes, including your overall impression to the _Review changes_ box.
...
- _Resolve conversation_ for items you have addressed.
- It's ok to disagree with some comments.
- Tag editor when you have finished addressing their comments.

When your review is complete, click _Comment_ or _Request changes_, at your discretion. 
