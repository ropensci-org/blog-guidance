...
The specific audience for this chapter is the person(s) reviewing and publishing a post, however, it may provide insights to post authors.
```
...
Copy and paste either the [editor checklist for a post about a peer-reviewed package]LINK, or the [editor checklist for any other post]LINK, into the box that appears when you click the green "Review changes" button.
...
Comment to explain the change if needed, for instance if the diff displayed by GitHub does not highlight which word(s) where edited.
...
After all inline commenting and the checklist is done, add any further notes, including your overall impression to the 'Review changes' box.
...
It can be added immediately after merging the post's PR by direct edit of the post file through the GitHub web interface.
