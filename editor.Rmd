...
While our [Style Guide](#styleguide) recommends that authors add [line breaks at the end of every sentence](https://cirosantilli.com/markdown-style-guide#line-wrapping), after the period, we do not ask them to add these in their draft after the fact.
...
After all inline commenting and the checklist is done, add any further notes, starting with your overall impression, to the _Review changes_ box.
