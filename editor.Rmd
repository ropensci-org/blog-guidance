...
This is to make the cross-post alert appear ([example](https://ropensci.org/blog/2023/08/01/r-universe-and-cran/)
as well as to make the cross-post metadata appear in the JSON feed that Rogue Scholar consumes.
