...
```{r twitter_default, echo = FALSE, fig.cap = "Example of tweet without twitterImg specified"}
...
```{r twitterImg, echo = FALSE, fig.cap = "Example of tweet with twitterImg specified"}
