...
show_template("https://github.com/ropensci/roweb2/raw/master/archetypes/md/index.md", lang = "markdown")
```
...
[Available on GitHub](https://github.com/ropensci/roweb2/blob/master/archetypes/Rmd/index.md) (_not displayed for copy-paste because of "html_preserve" tags_)
