...
This chapter explains the technical details of submitting a blog post or tech note for publication on the rOpenSci website - from drafting in an (R) Markdown template, to submitting for review using GitHub Pull Request infrastructure.
