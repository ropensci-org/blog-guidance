...
Create a folder `YYYY-MM-DD-slug` (e.g. `2020-01-20-rorcid`) under `/content/blog/` or `content/technotes/` for a blog post and a tech note, respectively. Your post source and its images should live in `/content/blog/YYYY-MM-DD-slug/` or `/content/technotes/YYYY-MM-DD-slug/`.

## Start the post choose your workflow
...
# show_template("post-template.Rmd", 
#               lang = "markdown",
#               details = TRUE
# )
```
