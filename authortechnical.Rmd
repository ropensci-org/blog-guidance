...
- To pull the image to the left or right with text wrapped around it (which you cannot do if producing the image from R Markdown), use our shortcode.

    - Image pulled to the left

```markdown
{{< imgtxt src="name-of-image.png" alt="this is the alternative text">}}

Text wrapped by the image blablabla.

{{< /imgtxt >}}
```

    - Image pulled to the right

```markdown
{{< imgtxt side="right" src="name-of-image.png" alt="this is the alternative text">}}
