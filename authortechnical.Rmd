...
If using [blogdown's New Post addin](#blogdownaddin) you won't need to manually create the folder.
_In Hugo speak, we'd say your post is a [leaf bundle](https://gohugo.io/content-management/page-bundles/#leaf-bundles)._


### Use any template with blogdown's New Post Addin {#blogdownaddin}

We recommend this approach because the blogdown New Post Rstudio addin handles the paths for you.
If you don't use RStudio you can still use the addin, but in e.g. Ubuntu the new could could first get opened in Vim.
...
### Get R Markdown or Markdown template manually
...
* [R Markdown template](#templatermd) is to be saved as `/content/blog/YYYY-MM-DD-slug/index.Rmd`. It will need to be knit (e.g. RStudio knit button). Add both `index.Rmd` and `index.md`to your PR.
