...
You can have accents, middle initials, or hyphens appear in your name if you name your folder appropriately (it can be tricky).
If you're not sure how to do this, look at [other people's folder names](https://github.com/ropensci/roweb2/tree/master/content/authors) for examples. 
