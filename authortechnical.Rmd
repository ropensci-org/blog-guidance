...
- In R Markdown, shortcodes need to be html escaped, refer to [the template](https://github.com/rosadmin/blog-guidance/blob/master/templates/author-file-template.Rmd) for an example.

If you want to **generate** images from R Markdown use [our R Markdown template](#templatermd) in order not to worry about paths.
...
Use a Hugo shortcode to embed a tweet using its ID e.g. `{{< tweet 1138216112808529920 >}}`. In R Markdown, shortcodes need to be html escaped, refer to [the template](https://github.com/rosadmin/blog-guidance/blob/master/templates/author-file-template.Rmd) for an example.
