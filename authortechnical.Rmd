...
Choose images that are relevant, clear, and useful to the reader. 
Images should support the content and should include [Alt text](#images---general) to meet our accessibility requirements.
We generally prefer not to use AI-generated or AI-modified images.
