...
The blogdown New Post Rstudio addin creates the post draft in the correct location and fills the post YAML based on metadata you'll have entered.
...
knitr::include_graphics("images/blogdownaddin.png")
```
  ...
  * Also choose the correct extension: .Rmd if Rmd, Markdown (.md) if md. Never choose .RMarkdown.
  * Ignore Categories.
