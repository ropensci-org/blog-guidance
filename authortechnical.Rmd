...
Send a pull request from your fork at least one week prior to the planned publication date to allow time for review.
Netlify will start building the new version of the site within seconds and you can preview your changes to make sure everything looks as intended.
...
```
A review from blog editor(s) will be automatically requested.
