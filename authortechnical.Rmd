...
If you plan to use R Markdown to write your post (as opposed to directly writing it in Markdown, not executing any code), please install or update blogdown.
...
This author file, [`/author/kelly-obriant/_index.md`](https://github.com/ropensci/roweb3/blob/HEAD/content/author/kelly-obriant/_index.md) 
...
show_template("https://github.com/ropensci/roweb3/raw/HEAD/archetypes/md/index.md", 
              lang = "yaml",
              yaml_only = TRUE)
```
