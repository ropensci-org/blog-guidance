...
The relevant YAML tags are `title`, `description`, `twitterImg`.
These same metadata tags might be picked up by other platforms such as Slack.

NOTE: code below trying to show tweet screenshot according to https://twitter.com/grrrck/status/1211856156412579840?s=20
`Error: 'tweet_screenshot' is not an exported object from 'namespace:webshot2'`

```{r twittercarddefault, fig.cap ="Summary Twitter Card for an rOpenSci URL"}
