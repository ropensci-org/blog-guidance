...
Prepare your post in your favorite editor in R Markdown **or** Markdown by starting with templates we provide in this book or using blogdown's handy New Post RStudio addin.
...
The blogdown New Post Rstudio addin handles the paths for you.
...
* Run blogdown's New Post addin from the RStudio addins menu or `blogdown:::new_post_addin()`

  * Enter a title, no need to worry about tile case.
