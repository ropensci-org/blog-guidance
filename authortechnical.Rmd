...
Example author file [`/authors/kelly-obriant/_index.md`](https://github.com/ropensci/roweb2/blob/master/content/authors/kelly-obriant/_index.md) 
...
that, when rendered, generates [Kelly O'Briant's author page](https://ropensci.org/authors/kelly-obriant/)

```{r authorpage, cache = TRUE, echo = FALSE, fig.cap ="Screenshot of Kelly O'Briant's author page"}
...
Then run `hugo serve` in the repo directory to start a local server on http://localhost:1313. To view a future-dated blog post, use `hugo serve -F` (IS THAT STILL TRUE? I DON'T THINK I HAVE TO DO THIS) .
