...
The [roblog package](https://docs.ropensci.org/roblog/) is an option that can help with these steps.
Its [installation and use](#roblogtemplates) are described below. 
